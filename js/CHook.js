function CHook(oSpriteHookClosed){
    ...
    // console.log('localStorage.getItem(yPos) 3 = ' + localStorage.getItem('yPos'));
		...
		var angle = Math.atan((xPos-HOOK_START_X)/(yPos-HOOK_START_Y));
		//var angle = Math.atan((1100-HOOK_START_X)/(650-HOOK_START_Y));
    ...
    this.zeroRotation = function(iSpeed){
      _oHookSprite.rotation = 0;
    };
