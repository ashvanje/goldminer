function CMenu(){
    ...
    this._init = function(){
        ...
        _pStartPosPlay = {x:1200,y:400};
        _pStartPosPlay2 = {x:450,y:400};
        _oButPlay = new CTextButton(_pStartPosPlay.x,_pStartPosPlay.y,oSprite,TEXT_PLAY,FONT_GAME,"#ffffff",44);
        _oButPlay2 = new CTextButton(_pStartPosPlay2.x,_pStartPosPlay2.y,oSprite,TEXT_PLAY,FONT_GAME,"#ffffff",44);
        _oButPlay.addEventListener(ON_MOUSE_UP, this._onButPlayRelease, this);
        _oButPlay2.addEventListener(ON_MOUSE_UP, this._onButPlayRelease0, this);
    ...
    this._onButPlayRelease0 = function(){
        this.unload();
