function CGame(oData){
    ...
    this._init = function(){
        ...
        _oGirlNormal = createBitmap(s_oSpriteLibrary.getSprite('girl_normal'));
        _oGirlNormal.x = 775;
        _oGirlNormal.y = 70;
        ...
        _oNuggetTopSprite.x = HOOK_START_X-200;
        _oNuggetTopSprite.y = HOOK_START_Y;
        ...
        // _oNuggetTopSprite.visible = true;
        ...
        _oChangeLevel = new CChangeLevel(oSprite, "", "", "", "TD");
    ...
    this._initNuggets = function(){
        ...
        console.log("aInfo[0].question = " + aInfo[0].question + ", _oQuestionTopText.text = " + _oQuestionTopText.text);
	...
	_iState = -1;
        ...
        // }else{
            ...
            if(_iCurLevel > _oLevelSettings.getNumLevels()){
                ...
                _oChangeLevel = new CChangeLevel(_oDraggingNugget.getSprite(), _oQuestionTopText.text, _oDraggingNugget.getText(), _oAnswerText.text, "TD");
    ...
    this.showHurt2 = function(){
        playSound("lk2b623_gam_07",1,false);
    ...
    this._gameOver = function(){
        ...
        _oEndPanel = new CEndPanel(s_oSpriteLibrary.getSprite('girl_lose'));
    ...
    this._win = function(){
        ...
        _oEndPanel = new CEndPanel(s_oSpriteLibrary.getSprite('girl_win'));
    ...
    this.onExitHelp = function(){
        // playSound("lk2b623_gam_03",1,false);
        // s_aSounds["lk2b623_gam_03"].on('end', function(){
            _bUpdate = true;
        // });
    };
            ...
            case STATE_HOOK_MOVE_BACK:{
                ...
                if(_oDraggingNugget.isCorrect()==false) {
                  ...
                  if (_isLock == true) {
                      ...
                      playSound("lk2b623_gam_05",1,false);
                      playSound("lk2b623_gam_06",1,false);
