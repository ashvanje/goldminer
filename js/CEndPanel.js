function CEndPanel(oSpriteBg){
    ...
    this._init = function(oSpriteBg){
        ...
        _oBg.x = CANVAS_WIDTH/2-oSpriteBg.width/2;
        _oBg.y = CANVAS_HEIGHT/2-oSpriteBg.height/2;
        ...
        _oBlackScreen.graphics.beginFill("black").drawRect(0,0,CANVAS_WIDTH,CANVAS_HEIGHT);
        _oBlackScreen.alpha = 0.1;
        _oBlackScreen.visible = true;
        ...
        _oGroup.addChild(_oBlackScreen, _oBg);
